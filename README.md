...
**репозиторий**: https://github.com/Suspend85/em-aqa-test

## Проверяет 5 сценариев
1. [x] Успешный логин (standard_user / secret_sauce)
2. [x] Логин с неверным паролем
3. [x] Логин заблокированного пользователя (locked_out_user)
4. [x] Логин с пустыми полями
...
- Python `3.10`
- Установленный Allure CLI (если необходимо смотреть отчёт локально)
